<?php $formatNumber->formatNumber(1000500); ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row">
                    <div class="col-md-4 clearfix">
                        <div class="logo pull-left">
                            <a href="Views/frontend/products/index.php"><img src="public/images/home/logo.png" alt="" /></a>
                        </div>
                                ...
                                <?php foreach ($categories as $key => $category) : ?>
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title"><a style="cursor: pointer;" class="category" id="<?php echo $category['id'] ?>"><?php echo $category['name'] ?></a></h4>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    <?php if (!empty($brands)) : ?>
                                        <?php $productRandom = rand(1, 100); ?>
                                        <?php foreach ($brands as $key => $brand) : ?>
                                            <li><a href="#"> <span class="pull-right"><?php echo "($productRandom)"; ?></span><?php echo $brand['name'] ?></a></li>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </ul>
                            </div>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="public/images/home/<?php echo $images[0]['name']; ?>" alt="" />
                                                <h2><?php echo $formatNumber->formatNumber($product['price']); ?> VND</h2>
                                            ...
                                            <div class="product-overlay">
                                                <div class="overlay-content">
                                                    ...
                                                    <p><?php echo $product['name'] ?></p>
                                                    <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                                    <a href="?controller=product&action=show&id=<?php echo $product['id'] ?>" class="btn btn-default add-to-cart"><i class="fa fa-info"></i>Detail</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="choose">
                ...
                data.map(item => {
                    ...
                    <div class="col-sm-4">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="public/images/home/${item.image}" alt="" />
